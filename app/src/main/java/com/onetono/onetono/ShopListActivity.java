...
public class ShopListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(ShopDummyContent.ITEMS));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        private final List<ShopDummyContent.DummyItem> mValues;

        public SimpleItemRecyclerViewAdapter(List<ShopDummyContent.DummyItem> items) {
            mValues = items;
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ShopDummyContent.DummyItem mItem;
